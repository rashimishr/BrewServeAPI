...
namespace BrewServe.Tests.Services
{
    ...
    public class BeerServiceTests
    {
        ...
        private BeerFilterContext _filterContext;
        ...
        public void SetUp()        
        {
            ...
            _filterContext = new BeerFilterContext(new List<IBeerSearchStrategy> { _strategyMock.Object });
            _beerService = new BeerService(_unitOfWorkMock.Object, _mapperMock.Object, _filterContext);
        }
        ...
        public async Task UpdateBeerAsync_ShouldUpdateBeer()
        {
            ...
            // Act
            var result = await _beerService.UpdateBeerAsync(beerRequest, 1);
